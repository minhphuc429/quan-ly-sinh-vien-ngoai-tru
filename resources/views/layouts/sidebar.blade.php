    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::segment(1) === 'home' ? 'active' : null }} treeview ripple">
                <a href="{{ action('HomeController@index') }}"> <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                </a>
            </li>
            <li class="{{ Request::segment(2) === 'sinhviens' ? 'active' : null }} treeview ripple">
                <a href="{{ action('SinhVienController@index') }}"> <i class="fa fa-user"></i> <span>Sinh Viên</span>
                </a>
            </li>
